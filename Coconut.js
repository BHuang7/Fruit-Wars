function coconut(game, terrain,  manager, playerData) {
	...
	this.CollisionCicle = new CollisionCircle(this, game, this.radius, this.scalingFactor, terrain, 11, 10, this.offsetRadii);
    this.ctx = game.ctx;
...
coconut.prototype.draw = function () {
	...
	if (this.player.hp <= 0){
		this.manager.turn2.splice(0, 1);
		this.removeFromWorld = true;
	}
	drawHealthbar(this.ctx, this.x, this.y, this.width / 2 - 10, 10, this.player.hp, 100, true, this.healthBarColor);
