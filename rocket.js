function rocket(game,startX, startY, velocityX, velocityY, manager, terrain) {	
	...
	this.collisionCircle = new CollisionCircle(this, this.radius, .05, this.terrain, -9, -10, 0);
    this.ctx = game.ctx;
...
rocket.prototype.draw = function () {
		...
		this.collisionCircle.debugDraw();	
